...
class Dbdatatext extends Module
{
    ...
    {
        Configuration::deleteByName('DBDATATEXT_LIVE_MODE');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitDbdatatextModule')) == true) {
            $this->postProcess();
        }
    ...
    {
       $ofus = rtrim(strtr(base64_encode($data), '+/', '-_'), '=');
       return $ofus;
    }
